...
def getRandomPipe():
    ...
    y2 = offset + random.randrange(0, int(SCREENHEIGHT - GAME_SPRITES['base'].get_height()  - 0.9 *offset))#0.9
...
if __name__ == "__main__":
    ...
    pygame.display.set_caption('Flappy Bird by gyan jyoti')
    ...
    GAME_SOUNDS ['over']= pygame.mixer.Sound('gallery/sounds/sfx_over.wav')
